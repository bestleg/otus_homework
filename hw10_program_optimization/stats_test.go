...
{"Id":6,"Name":"Oleg Losyakov","Username":"oleg","Email":"encrypted@yandex.ru","Phone":"encrypted","Password":"acSBF5","Address":"Russell Trail 61"}`
...
{"Id":6,"Name":"Oleg Losyakov","Username":"oleg","Email":"encrypted@yandex.ru","Phone":"encrypted","Password":"acSBF5","Address":"Russell Trail 61"}`
	...
	for n := 0; n < b.N; n++ {
		_, _ = GetDomainStat(bytes.NewBufferString(data), "net")
	}
}
